...
Aplikasi ini mensimulasikan proses transfer uang dengan konfigurasi runtim dari file json. Pada awalnya aplikasi akan membaca konfigurasi, apabila tidak tersedia maka akan menggunakan nilai default. Aplikasi menampilkan pesan untuk memasukkan jumlah uang, menghitung biaya transfer berdasarkan config 'threshold', menampilkan metode transfer, dan meminta konfirmasi pengguna sebelum menyelesaikan transaksi.
