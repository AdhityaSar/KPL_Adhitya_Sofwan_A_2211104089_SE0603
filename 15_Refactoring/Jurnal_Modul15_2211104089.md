...
users.json (setelah menjalankan registrasi pada jurnal15.js) :
```
{
  "adit": {
    "password": "6d11033b009997e8606701d0f9c6b1dbe7b4fc5844ced78078a63585a533c9a9"
  }
}
```
...
Kode ini adalah aplikasi login dan registrasi sederhana yang disesuaikan dengan ketentuan jurnal modul 15. Kode ini sudah memenuhi faktor input validation dan password management.